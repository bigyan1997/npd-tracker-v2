const linkClass =
  'rounded-md border border-[#5c7669] bg-transparent px-3.5 py-2 text-[13px] font-semibold text-[#f4f2e9] no-underline hover:bg-[#4a6558]'
  ...
  return (
    <div className="flex items-center justify-between border-b-[3px] border-clay bg-moss-dark px-7 py-4 text-[#f4f2e9]">
      ...
      <div className="flex flex-wrap items-center justify-end gap-2.5">
        ...
        {links?.photos && (
          <a href={links.photos} target="_blank" rel="noopener noreferrer" className={linkClass}>
            Photos ↗
          </a>
        )}
