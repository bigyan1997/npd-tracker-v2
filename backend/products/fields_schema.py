...
FIELDS = [
    ...
    {"key": "tastingNotes", "label": "Detailed Description After Tasting", "type": "textarea",
     "section": "Sampling & Tasting"},
    {"key": "supplierDescription", "label": "Description from Supplier (website / discussion)", "type": "textarea",
     "section": "Sampling & Tasting"},
    ...
    {"key": "shelfLife", "label": "Shelf Life of Product", "type": "text", "section": "Nutritionals & Compliance"},
    {"key": "features", "label": "Features — e.g. GF, DF, Halal", "type": "text",
     "section": "Nutritionals & Compliance"},

    {"key": "unitsPerBox", "label": "Units per Box", "type": "number", "section": "Commercial"},
    {"key": "supplierAvailableFrom", "label": "Supplier Available From Date", "type": "date", "section": "Commercial"},
    {"key": "supplierProductCode", "label": "Supplier Product Code", "type": "text", "section": "Commercial"},
    ...
    {"key": "supplierProductName", "label": "Supplier product name (if different to ACP product name)",
